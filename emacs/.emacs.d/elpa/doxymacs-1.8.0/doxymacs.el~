...
;; felix modified at Sat 27 Aug 09:45:46 UTC 2016
...
;; felix modified at Sat 27 Aug 09:46:16 UTC 2016
...
;; modified by felix at Sat 27 Aug 04:28:28 UTC 2016
;; yview C coding style.
(defconst doxymacs-C++-file-comment-template
 '("/****************************************************************************************" > n
   ...
   (if (buffer-file-name)
     ...
     " * 公司介绍及版权说明" > n
     " *" > n
     " *           (C)Copyright 2012 YView    Corporation All Rights Reserved." > n
     " *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -" > n
     " ***************************************************************************************/" > n
     )
...
;; felix modified at Sat 27 Aug 09:38:39 UTC 2016
(defconst doxymacs-C++-function-comment-template
 '((let ((next-func (doxymacs-find-next-func)))
	 ...
	 (list
	  'l
	  "/**************************************************" '> 'n
	  " * 函 数 名：" (cdr (assoc 'func next-func)) '> 'n
	  " * 功    能：" 'p '> 'n
	  (doxymacs-parm-tempo-element (cdr (assoc 'args next-func)))
	  " * 输出参数：无 " '> 'n
	  ...
	  (unless (string-match
                   ...
                   doxymacs-void-types)
	    '(l
	      " * 返 回 值：YV_SUCCSS: 成功; YV_FAIL: 失败" (p "Returns: ") > n)
	    )
	  "*************************************************/" '>)
       (progn
	 (error "Can't find next function declaraton.")
